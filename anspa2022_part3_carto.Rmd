...
map_iris_hlm<-readRDS("tmp/map_iris_hlm.RDS")
map_com_hlm<-readRDS("tmp/map_com_hlm.RDS")
```
...
On peut ajouter une couche de texte avec la fonction `mf_label()`. Par exemple, on va ajouter à la carte précédente le nom des départements
...
mf_map(map_iris_hlm, var = "HLM1",type = "prop",
...
mf_map( map_iris_hlm, var = "HLMpct",type = "choro",
...
mf_prop_choro( x = map_iris_hlm,  var = c("TOT", "HLMpct"), 
